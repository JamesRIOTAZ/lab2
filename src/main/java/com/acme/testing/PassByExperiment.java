...
public class PassByExperiment {
	...
	public static void main(String[] args) {
		...
		System.out.println("");
		StringBuilder s = new StringBuilder(date.toString());
		System.out.println("Before passing a String " + s);
		passStringBuilder(s);
		System.out.println("After passing a String " + s);
	...
	public static void passStringBuilder(StringBuilder s) {
		s.replace(s.lastIndexOf("/")+1, s.lastIndexOf("/")+5, "2012");
		System.out.println("New date string: "+s);
	}
